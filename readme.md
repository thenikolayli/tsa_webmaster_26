...
https://www.washingtontsa.org/high-school-events/webmaster
...
# Features
- FastAPI CRUD API - Create, Read, Update, Destroy API for interacting with the database for interacting with the community resources.
- SvelteKit frontend - Frontend.
- SQLite3 DB - Database to save community resources and user info.
- User functionality so admins can create new resources based on the form.
